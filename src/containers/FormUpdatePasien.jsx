    ...
    <form onSubmit={props.onSubmit}>
      ...
      <div className="form-group">
        ...
        <input
          ...
          name="nama"
          defaultValue={props.pasien.nama}
          readOnly
        />
      </div>
      <div className="form-group">
        ...
        <input
          ...
          name="tanggalRujukan"
          defaultValue={
            !props.pasien.tanggalRujukan ? "" : props.pasien.tanggalRujukan
          }
        />
      </div>
      <div className="form-group">
        ...
        <select
          ...
          name="poliRujukan.id"
          defaultValue={
            !props.pasien.poliRujukan ? "" : props.pasien.poliRujukan.id
          }
        >
      ...
      <div className="form-group">
        <label>
          Status Pasien<span style={{ color: "red" }}>*</span>
        </label>
        <select
          className="form-control"
          name="statusPasien.id"
          defaultValue={
            !props.pasien.statusPasien ? "" : props.pasien.statusPasien.id
          }
          required
        >
